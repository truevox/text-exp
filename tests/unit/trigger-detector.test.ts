...
import { TriggerDetector, TriggerMatch, TriggerState } from '../../src/content/trigger-detector';
...
describe('TriggerDetector', () => {
  ...
  describe('Performance Considerations', () => {
    test('should handle long input efficiently', () => {
      ...
      const result = detector.processInputWithContext(longInput, longInput.length - 5);
